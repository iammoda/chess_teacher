...
export function classifyMoveQuality({
  ...
  const missedForcedMate = typeof mateBefore === "number" && mateBefore > 0 && !(typeof mateAfter === "number" && mateAfter < 0);
...
function qualityReasonFor(key, { loss, playedBest, openingKnown }) {
  ...
  if (key === "inaccuracy" && loss !== null) return `This gave away about ${loss} centipawns.`;
  if (key === "mistake" && loss !== null) return `This lost about ${loss} centipawns.`;
  if (key === "blunder" && loss !== null) return `This lost about ${loss} centipawns.`;
