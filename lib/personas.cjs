// Coach persona definitions for server-side CommonJS code.
//
// Keep this catalog in sync with personas.mjs, which is served to the browser.
// Personas are VOICE ONLY. Every coaching rule in lib/coach-chat.js applies to
// all of them.
