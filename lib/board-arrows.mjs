...
export function squareCenter(square, flipped) {
  ...
  const rankIndex = Number(String(square || "")[1]) - 1;
  // Both axes range-checked: "a9"/"a0" must return null, not an off-viewBox
  // coordinate.
  if (fileIndex < 0 || !Number.isInteger(rankIndex) || rankIndex < 0 || rankIndex > 7) return null;
