// Coach persona definitions for the browser (Settings picker, chat payload).
//
// lib/personas.cjs is the server copy of this catalog (Vercel's Node runtime
// may predate require(esm)). The two files MUST stay identical —
// tests/personas-sync.test.mjs deep-compares them and fails the suite on any
